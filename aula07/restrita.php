...
<body>
    ...
    <header class="position-relative d-flex align-items-center justify-content-center"
        ...
        <div class="container position-relative text-center text-white">
            ...
            <p class="lead fs-3 mb-4">Descubra a história e o poder da linguagem que move a web moderna.</p>
            <a href="#historia" class="btn btn-primary btn-lg px-5 py-3 fw-bold rounded-pill">Começar Leitura</a>
        </div>
    </header>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted">A introdução do motor Zend e do compilador JIT transformaram
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm p-3">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted">Hoje, alimenta gigantes como WordPress e Facebook, estando
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead">O PHP não parou no tempo. As versões recentes trouxeram ganhos que o colocam lado a
                        lado com linguagens modernas em termos de velocidade.</p>
                    <ul class="list-unstyled">
                        <li class="mb-2"><strong><i class="bi bi-check2-circle text-primary me-2"></i>PHP 7:</strong>
                            Redução de 50% no consumo de memória.</li>
                        <li class="mb-2"><strong><i class="bi bi-check2-circle text-primary me-2"></i>PHP 8:</strong>
                            Compilação JIT para processamento pesado.</li>
                        <li class="mb-2"><strong><i class="bi bi-check2-circle text-primary me-2"></i>Tipagem:</strong>
                ...
                <div class="col-md-5">
                    <div class="d-flex align-items-start p-4 border border-secondary rounded hover-effect">
                        ...
                        <div>
                            ...
                            <p class="text-secondary mb-0">O framework mais popular do mundo, focado na experiência do
            ...
            <div class="row border-bottom border-secondary pb-4 mb-4">
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <ul class="list-unstyled small text-secondary">
                        ...
                        <li>W3Techs - <a href="https://w3techs.com/technologies/history_details/pl-php" target="_blank"
                                class="text-decoration-none text-secondary">Estatísticas Web</a></li>
                    </ul>
                </div>
            </div>
